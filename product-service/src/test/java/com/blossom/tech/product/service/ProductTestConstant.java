...
public class ProductTestConstant {
    ...
    public static String PRODUCT_DESCRIPTION = "It's a Macbook";

    public static UUID FIRST_CATEGORY_ID = UUID.fromString("886af338-59de-4f61-b0b2-f17261e8ea21");
    public static UUID SECOND_CATEGORY_ID = UUID.fromString("ca62bf02-3732-4caf-bae4-0e3eb2dc41e6");
